...
// Aislado de rudewear/toolhome — cada sub tiene su propio flag.
export const ADMIN_2FA_WINDOW_MS = 30 * 60 * 1000;
export const ADMIN_2FA_FIELD = 'notaryjoseAdmin2faPassedAt' as const;

interface UserDocData {
  role?: string;
  email?: string;
  notaryjoseAdmin2faPassedAt?: { toMillis: () => number } | null;
  [k: string]: unknown;
}
